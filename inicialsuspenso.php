...
<title>CCS - Clientes Suspensos</title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario where statuscontrato=2 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Clientes - Suspensos</h1></center>
			</div>
