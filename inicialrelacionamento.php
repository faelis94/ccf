...
<title>CCS - Clientes em Relacionamento</title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario where origemcr=3 and statuscontrato=0 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Clientes - Relacionamento</h1></center>
			</div>
