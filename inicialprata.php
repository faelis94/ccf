...
<title>CCS - Clientes Prata</title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario where classificacao=2 and statuscontrato=0 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Clientes - Prata</h1></center>
			</div>
