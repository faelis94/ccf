...
<?php
	...
	include("classe/conexao.php");
			...
			$sql_code = "SELECT * FROM usuario where statuscontrato=0  order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Clientes - Todos</h1></center>
			</div>
					...
					<table class="table table-hover" id="myTable"  >
						<thead>
							<tr >
								...
								<th class="text-center"><font size="4">Email</th>
