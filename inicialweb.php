...
<title>CCS - Sistema Web</title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario where ambiente=3 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Clientes - Clientes com ambiente Web</h1></center>
			</div>
