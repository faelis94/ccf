...
//inclusão de informações pos cadastro
	...
	if(!isset($_GET['demandas']))
		echo "<script> alert('Codigo invalido.'); location.href='matriz.php'; </script>";
	else{
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
     ...
     ?>
      ...
      <li><a href="home2.php?">Home</a></li>
        ...
        <li><a href="matriz.php">Matriz</a></li>
         <li><a href="index.php?p=cadastrojustificativa">Justificativa de ponto</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><a href="logout.php"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
      </ul>
...
<div class="row">
  <div class="col-75">
    <div class="container">
     <form action="editardemanda.php?p=editardemanda&demandas=<?php echo $usu_codigo; ?>" method="POST">
