...
<title>CCS - Demandas Criticas</title>
...
<?php
	...
	include("classe/conexao.php");
		...
		$sql_code = "SELECT * FROM demandas where demandacr=3 order by datademanda DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Demandas - Criticas</h1></center>
			</div>
