...
<title>CCS - Clientes em Berçario</title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario where bercario=1 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Clientes - Berçario</h1></center>
			</div>
