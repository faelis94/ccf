...
<title>CCS - Demandas em Alerta </title>
...
<?php
	...
	include("classe/conexao.php");
		...
		$sql_code = "SELECT * FROM demandas where demandacr=2 order by datademanda DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Demandas - Em Alerta</h1></center>
			</div>
