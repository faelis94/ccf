...
<title>CCS - Clientes Bronze</title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario where classificacao=4 and statuscontrato=0 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Clientes - Bronze</h1></center>
			</div>
