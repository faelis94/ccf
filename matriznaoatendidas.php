...
<?php
	...
	include("classe/conexao.php");
		...
		$sql_code = "SELECT * FROM demandas where statusdemanda=2 order by datademanda DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Demandas - Não atendidas</h1></center>
			</div>
