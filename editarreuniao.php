...
//inclusão de informações pos cadastro
	...
	if(!isset($_GET['reuniao']))
		echo "<script> alert('Codigo invalido.'); location.href='reunioes.php'; </script>";
	else{
...
<div class="row">
  <div class="col-75">
    <div class="container">
     <form action="editarreuniao.php?p=editarreuniao&reuniao=<?php echo $usu_codigo; ?>" method="POST">
