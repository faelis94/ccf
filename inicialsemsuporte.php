...
<title>CCS - Clientes sem Suporte</title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario where datadecadastro BETWEEN CURDATE() - INTERVAL 240 DAY AND CURDATE() and statuscontrato=0 and semsuporte=0 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Clientes - Sem Suporte</h1></center>
			</div>
