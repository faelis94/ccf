...
<title>CCS - Clientes Alerta </title>
<?php

	include("classe/conexao.php");

		$sql_code = "SELECT * FROM usuario where cancelados=1  and statuscontrato=0 and critico=0 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
			<div class="page-header" >
				<center><h1>Lista de Clientes - Alerta</h1></center>
			</div>
