...
<title>CCS - Clientes em Implantação</title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario where origemcr=1 and statuscontrato=0 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
			...
			<center>	<h1>Lista de Clientes - Em Implantação</h1></center>
			</div>
