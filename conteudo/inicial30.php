...
<title>CCS - Clientes 30 Dias </title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario where datadecadastro BETWEEN CURDATE() - INTERVAL 30 DAY AND CURDATE()  and statuscontrato=0 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
			...
			<center>	<h1>Lista de Clientes - 30 Dias</h1> </center>
			</div>
