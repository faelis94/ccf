...
<title>CCS - Clientes Inadimplentes</title>
<?php

	include("classe/conexao.php");

		$sql_code = "SELECT * FROM usuario where inadimplente=1  and statuscontrato=0 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
			<div class="page-header" >
				<center><h1>Lista de Clientes - Inadimplentes</h1></center>
			</div>
