...
<title>CCS - Clientes Cancelados Dias </title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario where statuscontrato=1  order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
			...
			<center>	<h1>Lista de Clientes - Cancelados </h1></center>
			</div>
