...
<title>CCS - Clientes Diamante </title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario where classificacao=3 and statuscontrato=0 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
			...
			<center>	<h1>Lista de Clientes - Diamante</h1></center>
			</div>
	...
	<tr>
		...
		?></td>
            ...
            if ($linha['statuscontrato'] == 0 ){
	         ...
	         if ( $linha['cancelados'] == 2 and $linha['statuscontrato'] == 0  ){
	               $status = 2;                      
	         }
