...
$sql = "SELECT count(*) as total FROM usuario where cancelados<1  and statuscontrato=0 and critico=0 and datadecadastro BETWEEN CURDATE() - INTERVAL 120 DAY AND CURDATE()";
$r = $con->query($sql) or die($con->error);
...
$sql = "SELECT count(*) as total FROM usuario where cancelados=1  or recorrente=1 and statuscontrato=0  and datadecadastro BETWEEN CURRENT_DATE()-411.42 AND CURRENT_DATE() ";
$r = $con->query($sql) or die($con->error);
...
$sql = "SELECT count(*) as total FROM usuario where cancelados>1  or critico=1 or status=2 or status=3 and statuscontrato=0  and datadecadastro BETWEEN CURDATE() - INTERVAL 120 DAY AND CURDATE()";
$r = $con->query($sql) or die($con->error);
...
$sql = "SELECT count(*) as total FROM usuario where implantadorrafael=1 and datadecadastro BETWEEN CURDATE() - INTERVAL 120 DAY AND CURDATE()";
...
$sql = "SELECT count(*) as total FROM usuario where implantadorkarina=1 and datadecadastro BETWEEN CURDATE() - INTERVAL 120 DAY AND CURDATE()";
...
$sql = "SELECT count(*) as total FROM usuario where implantadorwesley=1 and datadecadastro BETWEEN CURRENT_DATE()-411.42 AND CURRENT_DATE() ";
...
$sql = "SELECT count(*) as total FROM usuario where implantadorsamantha=1 and datadecadastro BETWEEN CURDATE() - INTERVAL 120 DAY AND CURDATE()";
...
//*Controle cancelados , suspensos e entrada
 ...
 $sql = "SELECT count(*) as total FROM usuario where nome is not null and datadecadastro BETWEEN CURDATE() - INTERVAL 120 DAY AND CURDATE()";
$r = $con->query($sql) or die($con->error);
...
$total120dias = $r->fetch_object()->total;
 ...
 $sql = "SELECT count(*) as total FROM usuario where statuscontrato=1 and datadecadastro BETWEEN CURDATE() - INTERVAL 120 DAY AND CURDATE()";
$r = $con->query($sql) or die($con->error);
...
$totalcancelados120 = $r->fetch_object()->total;
 ...
 $sql = "SELECT count(*) as total FROM usuario where statuscontrato=2 and datadecadastro BETWEEN CURDATE() - INTERVAL 120 DAY AND CURDATE()";
$r = $con->query($sql) or die($con->error);
...
<ul class="nav nav-pills nav-stacked">
        ...
        <li ><a href="index.php?p=reunioes">Reuniões</a></li>
        <li ><a href="index.php?p=justificativas">Justificativas de Ponto</a></li>
