...
<title>CCS - Clientes com conversão em andamento</title>
<?php

	include("classe/conexao.php");
class="form-control input-sm"
			$sql_code = "SELECT * FROM usuario where datadecadastro BETWEEN CURDATE() - INTERVAL 240 DAY AND CURDATE() and statusconversao=2 and statuscontrato=0 and semsuporte=0 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Clientes - Conversão em andamento</h1></center>
			</div>
