...
$sql = "SELECT count(*) as total FROM usuario where cancelados<1  and statuscontrato=0 and critico=0 and datadecadastro BETWEEN CURDATE() - INTERVAL 30 DAY AND CURDATE()";
$r = $con->query($sql) or die($con->error);
...
$sql = "SELECT count(*) as total FROM usuario where cancelados=1  or recorrente=1 and statuscontrato=0  and datadecadastro BETWEEN CURDATE() - INTERVAL 30 DAY AND CURDATE()";
$r = $con->query($sql) or die($con->error);
...
$sql = "SELECT count(*) as total FROM usuario where cancelados>1  or critico=1 or status=2 or status=3 and statuscontrato=0  and datadecadastro BETWEEN CURDATE() - INTERVAL 30 DAY AND CURDATE()";
$r = $con->query($sql) or die($con->error);
...
$sql = "SELECT count(*) as total FROM usuario where implantadorsamantha=1 and datadecadastro BETWEEN CURDATE() - INTERVAL 30 DAY AND CURDATE()";
...
//*Controle cancelados , suspensos e entrada
 ...
 $sql = "SELECT count(*) as total FROM usuario where nome is not null and datadecadastro BETWEEN CURDATE() - INTERVAL 30 DAY AND CURDATE()";
$r = $con->query($sql) or die($con->error);
...
$total120dias = $r->fetch_object()->total;
 ...
 $sql = "SELECT count(*) as total FROM usuario where statuscontrato=1 and datadecadastro BETWEEN CURDATE() - INTERVAL 30 DAY AND CURDATE()";
$r = $con->query($sql) or die($con->error);
...
$totalcancelados120 = $r->fetch_object()->total;
 ...
 $sql = "SELECT count(*) as total FROM usuario where statuscontrato=2 and datadecadastro BETWEEN CURDATE() - INTERVAL 30 DAY AND CURDATE()";
$r = $con->query($sql) or die($con->error);
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <title>CCS - Gerenciamento (30 Dias)</title>
 <style>
