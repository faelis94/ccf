...
<title>CCS - Clientes Criticos </title>
<?php

	include("classe/conexao.php");
 
		$sql_code = "SELECT * FROM usuario where critico=1 and statuscontrato=0 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
			<div class="page-header" >
				<center><h1>Lista de Clientes - Criticos</h1></center>
			</div>
