...
<title>CCS - Clientes em cancelamento</title>
<?php

	include("classe/conexao.php");

	
			$sql_code = "SELECT * FROM usuario where statuscontrato=3 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
			...
			<center>	<h1>Lista de Clientes - Em cancelamento</h1> </center>
			</div>
       ...
       <a class="test" tabindex="-1" href="#">Por Status <span class="caret"></span></a>
        <ul class="dropdown-menu">
          ...
          <li><a tabindex="-1" href="index.php?p=inicialcancelados">Clientes Cancelados</a></li>
           ...
           <li><a tabindex="-1" href="index.php?p=inicialsuspenso">Clientes Suspensos</a></li>
       ...
       <a class="test" tabindex="-1" href="#">Por Status Conversão<span class="caret"></span></a>
        <ul class="dropdown-menu">
          ...
          <li><a tabindex="-1" href="index.php?p=inicialconversaoandamento">Conversão em Andamento</a></li>
           ...
           <li><a tabindex="-1" href="index.php?p=inicialconversaocritica">Conversão Critica</a></li>    
    </ul>
...
<div class="row">
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" class="form-control input-sm" id="myInput1" onkeyup="myFunction1()" placeholder="Procurar pelo implantador" title="Digite o nome"></br>
				<div class="col-md-12">
