...
<title>CCS - Clientes com Oportunidade de venda</title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario  where geraoportunidade=1 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Clientes - Gera oportunidade de venda</h1></center>
			</div>
