...
$sql = "SELECT count(*) as total FROM usuario where notanps is not NULL  ";
$r = $con->query($sql) or die($con->error);
 
$totalnps= $r->fetch_object()->total;


$sql = "SELECT count(*) as total FROM usuario where notanps=9 or notanps=10   ";
$r = $con->query($sql) or die($con->error);
 
$totalnpspromotor= $r->fetch_object()->total;


$totalnpspromotor=($totalnpspromotor*100)/$totalnps;

$sql = "SELECT count(*) as total FROM usuario where notanps BETWEEN  0 and 6";
$r = $con->query($sql) or die($con->error);
 
$totalnpsdetrator= $r->fetch_object()->total;


$totalnpsdetrator=($totalnpsdetrator*100)/$totalnps;




$percentualnps=$totalnpspromotor-$totalnpsdetrator;
...
$sql = "SELECT count(*) as total FROM usuario where implantadorrafael=1  and cancelados>1 and statuscontrato=0 and critico=0 ";
$r = $con->query($sql) or die($con->error);
...
$sql = "SELECT count(*) as total FROM usuario where implantadorwesley=1  and cancelados>1 and statuscontrato=0 and critico=0 ";
$r = $con->query($sql) or die($con->error);
...
$sql = "SELECT count(*) as total FROM usuario where implantadorkarina=1  and cancelados>1  and statuscontrato=0 and critico=0";
$r = $con->query($sql) or die($con->error);
...
if ($_SESSION['name']=='ricardo'||$_SESSION['name']=='simone'||$_SESSION['name']=='ulisses'){
...
<div class="container theme-showcase" role="main">
   ...
   if ($_SESSION['name']=='rafael'||$_SESSION['name']=='wesley'||$_SESSION['name']=='karina'||$_SESSION['name']=='simone'||$_SESSION['name']=='ulisses'||$_SESSION['name']=='ricardo'){
   ...
   Criticos
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="card card-body bg-light">
          <?php      
           if ($_SESSION['name']=='simone'||$_SESSION['name']=='ulisses'||$_SESSION['name']=='ricardo'){ ?>
           
           <h4><center><a href="#"><img src="Imgs/unnamed.png" class="media-object  img-responsive img-thumbnail"></a></center></h4>
            <p><center> <?php echo  number_format($percentualnps,2); ?>%</center></p> 
           
           <?php }  if ($_SESSION['name']=='rafael'||$_SESSION['name']=='wesley'||$_SESSION['name']=='karina'){ ?>      
      ...
      <?php   if ($_SESSION['name']=='rafael' || $_SESSION['name']=='karina' || $_SESSION['name']=='wesley'){  ?>
      <div class="container">
  <h2>Listagens</h2>
  ...
  <div class="card">
	...
	$linha = $sql_query->fetch_assoc();
	 ...
	 if ($_SESSION['name']=='andrew')  {
		...
		$sql_code = "SELECT * FROM justificativas where solicitante=7  order by data DESC";
	$sql_query = $mysqli->query($sql_code) or die($mysqli->error);
	$linha = $sql_query->fetch_assoc();
