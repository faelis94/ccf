...
<title>CCS - Clientes Ouro</title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario where classificacao=1 and statuscontrato=0 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Clientes - Clientes Ouro</h1></center>
			</div>
