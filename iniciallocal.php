...
<title>CCS - Sistema Local </title>
<?php

	include("classe/conexao.php");

			$sql_code = "SELECT * FROM usuario where ambiente=1 order by datadecadastro DESC";
...
<div class="container theme-showcase" role="main">
		...
		<center>		<h1>Lista de Clientes - Clientes com ambiente Desktop</h1></center>
			</div>
